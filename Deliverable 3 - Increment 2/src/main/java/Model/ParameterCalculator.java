...
//        performCalc(obstacle,runway);
  ...
  public static void performCalc(Obstacle obstacle, PhysicalRunway runway){
    ...
    calculateTORA(obstacle, runway.getLogicalRunways().get(0));
    calculateLDA(obstacle, runway.getLogicalRunways().get(0));
    calculateTODA(obstacle, runway.getLogicalRunways().get(0));
    ...
    calculateTODA(tempObs, runway.getLogicalRunways().get(1));
